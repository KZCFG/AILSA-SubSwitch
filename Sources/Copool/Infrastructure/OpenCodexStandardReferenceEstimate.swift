...
struct OpenCodexStandardReferenceEstimate: Equatable, Sendable {
...
struct OpenCodexStandardReferenceEstimator: Sendable {
    ...
    func estimate(_ input: OpenCodexStandardReferenceInput) -> OpenCodexStandardReferenceEstimate {
        ...
        ) -> OpenCodexStandardReferenceEstimate {
            OpenCodexStandardReferenceEstimate(
                status: status,
                picoUSD: nil,
                priceBasis: nil,
        ...
        return OpenCodexStandardReferenceEstimate(
