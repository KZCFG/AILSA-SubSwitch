...
struct OpenCodexLedgerMeteringRecord: Equatable, Identifiable, Sendable {
    ...
    let standardReferenceEstimate: OpenCodexStandardReferenceEstimate
...
struct OpenCodexPricingCatalog: Sendable {
    ...
    /// `OpenCodexVerifiedPricingCatalogLoader` stamps into `catalogVersion`.
...
struct OpenCodexLedgerMeteringReader: Sendable {
