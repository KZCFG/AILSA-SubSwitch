...
final class AccountsIdentityRegressionTests: XCTestCase {
    ...
    private func makeCoordinator(
        ...
        AccountsCoordinator(
            ...
            opencodeAuthSyncService: IdentityRegressionAILSA_SSAuthSyncService(),
...
private struct IdentityRegressionAILSA_SSAuthSyncService: AILSA_SSAuthSyncServiceProtocol {
